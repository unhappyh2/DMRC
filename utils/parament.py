...
def hyperparameters_process():
    ...
    parser.add_argument('--iteraction', type=int, default=2000, help='Number of epochs for training')
    parser.add_argument('--seed', type=int, default=42, help='Random seed')
    parser.add_argument('--timesteps', type=int, default=5, help='Number of timesteps for training')
    # 解析参数
