...
class mainModel(nn.Module):
    ...
    def Coach(self, num_epochs, train_edge_index, val_edge_index, genres_edge_index=None):
        ...
        for epoch in trange(num_epochs):
            ...
            if epoch % ITERS_PER_EVAL == 0:
                ...
                print(
                    f" emb_loss: {round(emb_loss.item(), 5)},")
                print(
    ...
    def Eval(self, test_edge_index, train_edge_index):
        ...
        with torch.no_grad():
            ...
            print(
                f"test_recall@{20}: {round(recall, 5)}, test_precision@{20}: {round(precision, 5)}, test_ndcg@{20}: {round(ndcg, 5)}")
        return
    ...
    def embedding(self, edge_index):
        users_emb_final, users_emb_0, items_emb_final, items_emb_0 = self.EmbedLayer(self.users_emb.weight,
                                                                                     self.items_emb.weight, edge_index)
